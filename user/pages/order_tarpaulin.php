...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO orders (client_id, product_type, design_file, width, height, quantity, fulfillment_method, notes, status)
            VALUES ('$client_id', 'Tarpaulin', '$design_file', '$width', '$height', '$quantity', '$fulfillment_method', '$notes', 'pending')";
